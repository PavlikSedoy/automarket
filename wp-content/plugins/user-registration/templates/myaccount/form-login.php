...
<!--						<label for="username">--><?php //_e( 'Username or email address', 'user-registration' ); ?><!-- <span class="required">*</span></label>-->
						<input type="text" class="user-registration-Input user-registration-Input--text input-text" name="username" id="username" value="<?php echo ( ! empty( $_POST['username'] ) ) ? esc_attr( $_POST['username'] ) : ''; ?>" placeholder="E-mail" />
					</p>
